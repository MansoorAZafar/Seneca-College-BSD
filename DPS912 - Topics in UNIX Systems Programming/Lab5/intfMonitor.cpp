...
int main(int argc, char *argv[])
{
	...
	// We pass NULL since we're overwriting old behavior
	// 	- IF we wanted to keep it / restore it, we would pass a sigaction
	safe_sigaction(SIGUSR1, "SIGUSR1");
	safe_sigaction(SIGUSR2, "SIGUSR2");
